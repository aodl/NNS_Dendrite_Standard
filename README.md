...
The anonymous neuron page loads cached evidence first and labels stale evidence explicitly. Its live-refresh action uses `force_refresh_compliance`, which bypasses only the cache shortcut and retains all refresh-abuse and cycle protections.
